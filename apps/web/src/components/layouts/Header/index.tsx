				...
				<div className="h-full flex flex-1 md:flex-initial justify-end">
					{user && (
						<div className="h-full flex gap-4 items-center">
							<Button variant="ghost" className="h-full hidden md:flex" asChild>
					...
					{!user && (
						<>
							<Button variant="ghost" className="h-full hidden sm:flex" asChild>
								<Link href="/sign-in">
									<span>Entrar</span>
									<SVGUser />
								</Link>
							</Button>
							<Link href="/sign-in" className="overflow-hidden grid place-items-center sm:hidden">
...
export function SVGUser({ className, ...props }: SVGUserProps) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className={cn("w-4", className)} {...props}>
