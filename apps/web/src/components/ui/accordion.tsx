...
>(({ colorScheme = "default", style, children, className, ...props }, ref) => {
	...
	return (
		<AccordionPrimitive.Item ref={ref} className={cn("relative", className, st.shadowEffect)} {...props}>
			{children}
			<i className={cn("absolute h-[1px] top-full right-0 left-0")} style={cssVariables(hues, style)} />
